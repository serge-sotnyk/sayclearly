import { RequestError, fetchConfig, generateExercise, getRequestErrorMessage, getRequestErrorMessageWithDetail, saveConfig, } from '../api_client.js';
import { advanceExerciseStep, applyGeneratedExercise, applyGenerationError, applyLoadedConfig, buildConfigUpdatePayload, buildGenerateRequest, startGeneration, } from '../app_state.js';
    ...
    const handleGenerate = async () => {
        ...
        try {
            ...
            if (controller.signal.aborted) {
                ...
                state.model = applyGenerationError(state.model, getRequestErrorMessageWithDetail(error, GENERATE_ERROR_STATUS));
            }
        }
        finally {
